...
import LoginSchema, { LoginFormData } from "@utils/schemas/login.schema"
import { login, signup } from "@utils/actions/login.action"

export default function Login() {
    const onSubmit = (data: LoginFormData) => signup(data);
    ...
    return (
        <main className="flex min-h-screen w-full relative justify-center items-center">
            <div className="flex gap-y-8 h-fit shadow-2xl w-[80vw] md:w-[50vw] lg:w-[40vw] 2xl:w-[30vw] flex-col justify-center items-center backdrop-blur-lg bg-zinc-200 bg-opacity-70 py-16 px-16 rounded-lg">
                ...
                <FormWrapper defaultValues={dv} onSubmit={onSubmit} schema={LoginSchema} classname="flex flex-col gap-y-4 w-full">
